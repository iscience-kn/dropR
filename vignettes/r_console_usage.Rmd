...
The `experimnetal_condition` column indicates belonging to a group each of which was treated differently. For example, one group received a different sequence of questions. 
